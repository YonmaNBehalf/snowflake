const independenceTrack = {
  ...
  "milestones": [{
      ...
      "signals": [
	      ...
	      "Research and efforts are monolithic and changes to plan are slow to process and execute"
      ],
      "examples": [
      ...
      "examples": [
	      ...
	      "Epic effort was continuous and context switching did not create much additional delay"
      ],
  }, {
      "summary": "",
      "signals": [
